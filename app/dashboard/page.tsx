    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-4 auto-rows-[180px]">
          ...
          <div className="md:col-span-4 lg:col-span-4 row-span-2 rounded-3xl border border-border bg-card/50 p-6 flex flex-col">
        ...
        {/* INDIVIDUAL SKILL CARDS SECTION */}
        <div className="mt-12">
